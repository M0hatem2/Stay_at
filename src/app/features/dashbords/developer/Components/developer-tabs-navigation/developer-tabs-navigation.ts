...
@Component({
  selector: 'app-developer-tabs-navigation',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './developer-tabs-navigation.html',
  styleUrls: ['./developer-tabs-navigation.scss'],
})
export class DeveloperTabsNavigation implements AfterViewInit {
  tabs: Tab[] = [];
  activeTab: string = '';
