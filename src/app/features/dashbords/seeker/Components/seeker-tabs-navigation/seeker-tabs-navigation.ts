...
@Component({
  selector: 'app-seeker-tabs-navigation',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './seeker-tabs-navigation.html',
  styleUrls: ['./seeker-tabs-navigation.scss'],
})
export class SeekerTabsNavigation implements AfterViewInit {
  tabs: Tab[] = [];
  activeTab: string = '';
